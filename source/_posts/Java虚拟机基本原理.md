    ...
    - 空间分配
        - 线程共享的
            ...
            - 堆
                ...
                - GC的运行逻辑
                    ...
                    ![GC运行逻辑](https://i.loli.net/2021/06/28/q7NYfmdDapVOBU9.png)
        ...
        - 线程私有
            ...
            - Java方法栈
                ...
                - 方法执行的内存模型
                    - 对局部变量，动态链表，方法出口，栈的操作进行存储，并且线程独享
...
- boolean 类型
    - 映射成int类型
        - true被映射为整数1
        - false被映射为整数0
        ![基本类型](https://i.loli.net/2021/06/28/k6pXaMj4rUJOFoH.png)
...
![判断是否需要清理对象的逻辑](https://i.loli.net/2021/06/28/dtOa3GUh5SkbAVY.png)
...
- 缺陷
    ...
    - 容易导致当我们需要使用大块的内存的时候，无法分配足够的连续内存
       ...
       ![标记清除算法](https://i.loli.net/2021/06/28/TkZEf72unqIHLBY.png)
...
- 缺陷
    ...
    ![复制算法](https://i.loli.net/2021/06/28/fQY3p1658zJkIxb.png)

### 5.3.3 标记整理算法

- 标记了以后会做整理，将所有存活的对象都向内存块一端移动，然后直接清理掉边界以外的内存

![标记整理算法](https://i.loli.net/2021/06/28/7CNKE8HvLgVzrPk.png)
...
![垃圾收集器列表](https://i.loli.net/2021/06/28/hsKHpeEGm4lQydA.png)
